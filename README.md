...
## COPYRIGHT
Copyright (C) 2022 by [**Zaid Mohammed Said**](https://github.com/zaidsaid-007) and [**Agatha Mwaniki**](https://github.com/Mwan3kii) </br>
All rights reserved
...
```
https://github.com/zaidsaid-007/simple_shell.git
```
